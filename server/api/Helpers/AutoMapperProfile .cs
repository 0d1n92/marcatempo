...
namespace api.Helpers
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<User, ResponseOperatorsDto>().ForMember(x => x.QrCode, opt => opt.MapFrom(usr => usr.QRCode.token)).ForMember(x => x.RoleName, opt => opt.MapFrom(usr => usr.Role.Name)); 
